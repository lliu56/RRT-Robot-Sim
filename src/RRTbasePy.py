...
class RRTMap:
    def __init__(self, start, goal, MapDimensions, obsdim, obsnum):
        ...
        self.graph_map = pygame.surface.Surface((self.Mapw, self.Maph))
        self.graph_map.fill((255, 255, 255))
        self.graph_map.set_alpha(120)
    ...
    def drawPath(self, path):
        for node in path:
            pygame.draw.circle(self.graph_map, self.Red, node, 3, 0)
        self.map.blit(self.graph_map,(0,0))
